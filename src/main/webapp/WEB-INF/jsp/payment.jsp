...
<div class="container" style="border: 4px solid #f5f5f5;">
    ...
    <div class="next_div">
        <%Object payMethod = request.getAttribute("payMethod");
            if (payMethod==null){ %>
        <a href="payment/${order.orderId}/2" class="toCart">支付</a>
        <% }else{ %>
        <a href="payment/${order.orderId}/${payMethod}" class="toCart">支付</a>
        <%}%>
