...
<div class="container" style="border: 1px solid #CCCCCC;height: 1000px;">
    ...
    <form class="form-horizontal" role="form" id="storeForm" method="post" action="admin/store/addition">
        ...
        <div class="form-group">
            <label for="storeName" class="col-sm-2 control-label">书店名称：</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" id="storeName" name="storeName" placeholder="书店名称">
            </div>
            <span></span>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2">
                <button type="submit" class="btn btn-lg btn-default" style="margin-left: 15px">
                    <span class='glyphicon glyphicon-plus'></span> 添加书店
                </button>
            </div>
        </div>
    </form>
