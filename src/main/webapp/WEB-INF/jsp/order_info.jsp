...
<div class="container">
    ...
    <form id="orderForm" action="order/creation" class="form-horizontal" method="post">
        <div class="row">
            ...
            <div class="form-group">
                <label for="confirmmail" class="col-sm-1 control-label">确认邮箱</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="confirmmail" name="confirmmail"
                           placeholder="请输入确认邮箱" value="${sessionScope.loginUser.email}">
                </div>
            </div>
            <div class="form-group">
