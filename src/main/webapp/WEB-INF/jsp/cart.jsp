...
<div class="container">
    ...
    <!--
        购物车主体
    -->
<%--     如果传进来的cart和cart.items为零--%>
    <c:if test="${cart == null || empty cart.cartItems}">
        <div class="row">
            <h1 class="h1">您的购物车为空，<a href="">请再逛一逛吧!</a></h1>
            <img src="img/sticker.jpg" alt="您的购物车为空">
        </div>
    </c:if>
    ...
    <c:if test="${cart != null && !empty cart.cartItems}">
        ...
        <div class="row account_div">
            <div id="batch">
                <a href="cart/clear" style="font-size: 20px;color: #000000">清空购物车</a>
